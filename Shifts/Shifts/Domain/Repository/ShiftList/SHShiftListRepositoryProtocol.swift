...
protocol SHShiftListRepositoryProtocol: AnyObject {
    /**
     Method that retrieves all available shifts and return an expected value depending of the result. Expected values of `ShiftListModel` for success and `SHError` for failure.
